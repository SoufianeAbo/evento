...
<!-- Mirrored from htmldemo.net/sparrk/sparrk/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Mar 2024 08:54:45 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Home || Spark</title>
    <meta name="description" content="Sparrk – Event & Conference HTML5 Template is a powerful HTML 5 Template. Build whatever you like with this template that looks effortlessly on-point in conference, consultations, courses, event, exhibition, landing page, meeting, responsive, seminar, startupetc. With all it features you can build something greater. It is ultimate flexible with loads of nice options and features.">
    ...
    <div class="wrapper">
        ...
        <div class="header-slider-area" id="home">
            ...
            <div class="header-area">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-8 d-none d-md-block">
                                <div class="phone-email">
                                    ...
                                    <div class="email"> <a href="mailto:company@domain.com"><i
                                                class="zmdi zmdi-email-open"></i>company@domain.com</a> </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-4">
                                <div class="login-register">
                                    <div class="login"> <a href="#"><i class="zmdi zmdi-account"></i>Login</a> </div>
                                    <div class="register"> <a href="#"><i
                                                class="zmdi zmdi-accounts-add"></i>Register</a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="sticker" class="logo-menu-area header-area-2">
                    ...
                    <div class="mobile-menu-area">
                        <div class="container">
                            <div class="logo-02">
                                <a href="index.html"><img src="img/logo-02.webp" alt=""></a>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                    <nav id="dropdown">
            ...
            <div class="slider-container bg-overlay">
                ...
                <div id="mainSlider" class="nivoSlider slider-image">
                    <img src="img/slider/slider1.webp" alt="main slider" title="#htmlcaption1" />
                    <img src="img/slider/slider2.webp" alt="main slider" title="#htmlcaption2" />
                </div>
                <!-- Slider Caption 1 -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="about-right">
                            <ul>
                                <li><i class="zmdi zmdi-calendar-note"></i>Sep 13, 2021</li>
                                <li><i class="zmdi zmdi-pin"></i>1080 Layman Court, New York</li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="tab-menu-list pt20 mb70 text-center">
                            <ul class="nav d-block happen-tab" role="tablist">
                                <li role="presentation"><a class="active" href="#day-one" aria-controls="day-one"
                                        role="tab" data-bs-toggle="tab">13, Feb 2021</a></li>
                                <li role="presentation"><a href="#day-two" aria-controls="day-two" role="tab"
                                        data-bs-toggle="tab">14, Feb 2021</a></li>
                                <li role="presentation"><a href="#day-three" aria-controls="day-three" role="tab"
                                        data-bs-toggle="tab">15, Feb 2021</a></li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
                        <!-- Tab panes -->
                        ...
                        <div class="total-speaker crasoule-btn">
                            ...
                            <div class="speaker-item">
                                <div class="single-speaker shadow-box text-center">
                                    <img src="img/team/team01.webp" alt="">
                            ...
                            <div class="speaker-item">
                                <div class="single-speaker shadow-box text-center">
                                    <img src="img/team/team02.webp" alt="">
                                    <h4 class="speaker-name uppercase"><strong>Patricia Morales</strong></h4>
                            ...
                            <div class="speaker-item">
                                <div class="single-speaker shadow-box text-center">
                                    <img src="img/team/team03.webp" alt="">
                                    <h4 class="speaker-name uppercase"><strong>Patricia Morales</strong></h4>
                            ...
                            <div class="speaker-item">
                                <div class="single-speaker shadow-box text-center">
                                    <img src="img/team/team04.webp" alt="">
                                    <h4 class="speaker-name uppercase"><strong>Patricia Morales</strong></h4>
        ...
        <div class="upcomming-events-area off-white ptb100">
            <div class="container">
                        ...
                        <div class="total-upcomming-event">
                            <div class="single-upcomming shadow-box">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="sue-pic">
                                            <img src="img/event/sue-01.webp" alt="">
                                        </div>
                            ...
                            <div class="single-upcomming shadow-box">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="sue-pic">
                                            <img src="img/event/sue-02.webp" alt="">
                                        </div>
                                        <div class="sue-date-time text-center">
                            ...
                            <div class="single-upcomming shadow-box">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="sue-pic">
                                            <img src="img/event/sue-03.webp" alt="">
                                        </div>
                                        <div class="sue-date-time text-center">
                            ...
                            <div class="single-upcomming shadow-box">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="sue-pic">
                                            <img src="img/event/sue-04.webp" alt="">
                                        </div>
                                        <div class="sue-date-time text-center">
                ...
                <div class="row">
                    <div class="col-12">
                        <a class="all-events uppercase text-center" href="#">All Events<i
                                class="zmdi zmdi-spinner"></i></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="apps-cont">
                            ...
                            <div class="right-app">
                                ...
                                <p>It is a long established fact that a reader will be distracted by theIpsum is that it
                                    has using It is a long established fact that a reader will be distracted.</p>
                                <div class="app-store">
                                    <a href="#"><img src="img/icon/google-play.webp" alt=""></a>
                                    <a href="#"><img src="img/icon/apple-store.webp" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="ready-to-play text-center">
            <div class="full-width-video">
                <video loop src="video/library.mp4" id="video-bg" class="stopfade"></video>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-3">
                        <div class="single-pricing-table shadow-box pt50">
                            ...
                            <div class="price-icon"> <img src="img/icon/price-01.webp" alt=""> </div>
                    ...
                    <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-3">
                        <div class="single-pricing-table shadow-box pt50">
                            ...
                            <div class="price-icon"> <img src="img/icon/price-02.webp" alt=""> </div>
                    ...
                    <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-3">
                        <div class="single-pricing-table shadow-box pt50">
                            ...
                            <div class="price-icon"> <img src="img/icon/price-03.webp" alt=""> </div>
                        ...
                        <div class="total-testimonial testi-border slider-pegi">
                            <div class="single-testimonial text-center">
                                ...
                                <div class="author-img mb25">
                                    <img src="img/team/test-01.webp" alt="">
                                </div>
                                <div class="testi-des">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="special-wrap">
                            ...
                            <p class="white-color">It is a long established fact that a reader will be distracted by the
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="total-brand">
                            <div class="single-brand"><img src="img/brand/01.webp" alt=""></div>
                            <div class="single-brand"><img src="img/brand/02.webp" alt=""></div>
                            <div class="single-brand"><img src="img/brand/03.webp" alt=""></div>
                            <div class="single-brand"><img src="img/brand/04.webp" alt=""></div>
                            <div class="single-brand"><img src="img/brand/05.webp" alt=""></div>
                            <div class="single-brand"><img src="img/brand/06.webp" alt=""></div>
                            <div class="single-brand"><img src="img/brand/01.webp" alt=""></div>
                            <div class="single-brand"><img src="img/brand/02.webp" alt=""></div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-4">
                        <div class="single-count text-center uppercase">
                            <div class="count-icon">
                                <img src="img/icon/count-01.webp" alt="">
                            </div>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="single-count text-center uppercase">
                            <div class="count-icon">
                                <img src="img/icon/count-02.webp" alt="">
                            </div>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="single-count text-center uppercase">
                            <div class="count-icon">
                                <img src="img/icon/count-03.webp" alt="">
                            </div>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="single-count text-center uppercase">
                            <div class="count-icon">
                                <img src="img/icon/count-04.webp" alt="">
                            </div>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="single-count text-center uppercase">
                            <div class="count-icon">
                                <img src="img/icon/count-05.webp" alt="">
                            </div>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="single-count text-center uppercase">
                            <div class="count-icon">
                                <img src="img/icon/count-06.webp" alt="">
                            </div>
                    ...
                    <div class="col-12">
                        <div class="total-news crasoule-btn">
                            <div class="news-item">
                                <div class="single-news">
                                    <div class="news-img animate-eff">
                                        <a href="#"><img src="img/blog/news-01.webp" alt=""></a>
                                    </div>
                                    <div class="news-contant">
                                        <h3 class="uppercase"><a href="#">Design & Develop concept fot new Designer</a>
                                        </h3>
                            ...
                            <div class="news-item">
                                <div class="single-news">
                                    <div class="news-img animate-eff">
                                        <a href="#"><img src="img/blog/news-02.webp" alt=""></a>
                                    </div>
                                    <div class="news-contant">
                                        <h3 class="uppercase"><a href="#">Design & Develop concept fot new Designer</a>
                                        </h3>
                            ...
                            <div class="news-item">
                                <div class="single-news">
                                    <div class="news-img animate-eff">
                                        <a href="#"><img src="img/blog/news-03.webp" alt=""></a>
                                    </div>
                                    <div class="news-contant">
                                        <h3 class="uppercase"><a href="#">Design & Develop concept fot new Designer</a>
                                        </h3>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="cal-to-wrap">
                            ...
                            <form action="#">
                                <div class="input-box">
                                    <input type="email" placeholder="Enter your E-mail Address" class="info"
                                        name="email">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="payment-area">
                            <ul>
                                <li><a href="#"><img src="img/icon/pay-01.webp" alt=""></a></li>
                                <li><a href="#"><img src="img/icon/pay-02.webp" alt=""></a></li>
                                <li><a href="#"><img src="img/icon/pay-03.webp" alt=""></a></li>
                                <li><a href="#"><img src="img/icon/pay-04.webp" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from htmldemo.net/sparrk/sparrk/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Mar 2024 08:55:08 GMT -->
</html>